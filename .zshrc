...
export ZSH="/Users/jailandrade/.oh-my-zsh"
...
# FSG project
run () { export CWD=$(pwd) && pnpm run $1; }

# development aliases...
alias lint="run lint"
alias dev="run dev"
alias dev-jobs="run dev-jobs"
...
# pnpm
export PNPM_HOME="/Users/jailandrade/Library/pnpm"
...
# . "$HOME/.asdf/asdf.sh" # Look into this
